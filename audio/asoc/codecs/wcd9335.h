...
static __inline__ void *tasha_get_afe_config(struct snd_soc_codec *codec,
				  enum afe_config_type config_type)
{
	return NULL;
}
static __inline__ int tasha_cdc_mclk_enable(struct snd_soc_codec *codec,
					int enable,
					bool dapm)
{
	return 0;
}
static __inline__ int tasha_cdc_mclk_tx_enable(struct snd_soc_codec *codec,
					   int enable,
					   bool dapm)
{
	return 0;
}
static __inline__ int tasha_enable_efuse_sensing(struct snd_soc_codec *codec)
{
	return 0;
}
static __inline__ int tasha_mbhc_hs_detect(struct snd_soc_codec *codec,
				struct wcd_mbhc_config *mbhc_cfg)
{
	return 0;
}
static __inline__ void tasha_mbhc_hs_detect_exit(struct snd_soc_codec *codec)
{
...
static __inline__ int tasha_set_spkr_mode(struct snd_soc_codec *codec, int mode)
{
	return 0;
}
static __inline__ int tasha_set_spkr_gain_offset(struct snd_soc_codec *codec,
					     int offset)
{
	return 0;
}
