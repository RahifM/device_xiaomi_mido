...
static __inline__ void tavil_mbhc_hs_detect_exit(struct snd_soc_codec *codec)
{
}
static __inline__ int tavil_mbhc_hs_detect(struct snd_soc_codec *codec,
				       struct wcd_mbhc_config *mbhc_cfg)
{
		return 0;
}
static __inline__ void tavil_mbhc_deinit(struct snd_soc_codec *codec)
{
}
